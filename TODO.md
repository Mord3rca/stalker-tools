...
* exec: Stalker env (executable to expose internal FS of Stalker)
  * [ ] Support for Read Only
  * [ ] Support for transparent Read / Write
    * [ ] On the fly XDB recompression on write / close

* lib: Gamefiles
  * [x] Parse gamefile structure (chunk type etc)
  * [ ] Read them all
    * [x] XDB
    * [ ] OMF
  * [ ] Writing
